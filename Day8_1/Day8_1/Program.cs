...
namespace Day8_1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var sotredNames = names.OrderBy(n => n);           
            ...
            foreach(var name in sotredNames)
            {
            ...
            *//*OrderByDescending       오름차순
            ...
            //문자열 배열 선언 (과일 이름 리스트)
            string[] fruits = { "apple", "banana", "blurberry", "cherry", "apricot" };
